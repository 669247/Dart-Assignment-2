...
class BankAccount {
  ...
  int accountNo;
  int balance;
  BankAccount(this.accountName, this.accountNo, this.balance);
}
...
class Bank {
  ...
  void delAccount() {
    ...
    accounts.forEach((account) {
      print(
          '${account.accountName} || ${account.accountNo} || \$${account.balance}');
    });
    print('Enter details to delete an account: ');
    String nameInput = stdin.readLineSync() as String;
    String name = nameInput;
    accounts.removeWhere((account) => account.accountName == name);
